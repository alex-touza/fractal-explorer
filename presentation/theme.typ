...
#let slide(
  ...
  let footer(self) = {
    ...
    if self.store.footer-progress {
      place(bottom, components.progress-bar(height: 5pt, self.colors.primary, self.colors.primary-light))
    }
  }
...
#let theme(
  ...
  show: touying-slides.with(
    ...
    config-colors(
      primary: purple.lighten(25%),//rgb("#eb811b"),
      primary-light: purple.lighten(80%),
      secondary: rgb("#785c9e"),
      neutral-lightest: rgb("#fafafa").mix((purple, 2%)),
      neutral-dark: rgb("#23373b").mix((purple, 40%)),
      neutral-darkest: rgb("#23373b").mix((purple, 40%)),
    ),
